			...
			get
			{
				switch (_Operation)
				{
					...
					case PXDBOperation.Update:
						_Message = PXMessages.LocalizeFormat(ErrorMessages.RecordUpdatedByAnotherProcess, out _MessagePrefix, _Table.Name);
						break;
					case PXDBOperation.Delete:
						_Message = PXMessages.LocalizeFormat(ErrorMessages.RecordDeletedByAnotherProcess, out _MessagePrefix, _Table.Name);
						break;
				}
				return base.Message;
			}
