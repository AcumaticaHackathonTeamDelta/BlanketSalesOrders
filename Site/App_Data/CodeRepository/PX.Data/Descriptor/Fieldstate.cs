...
namespace PX.Data
{
    ...
    /// cref="PXUIFieldAttribute">PXUIField</see> attribute to specify when
	...
	public class PXSegmentedState : PXStringState
	{
		...
		private static string[] _segmentHeaderListCached;
		...
		public static PXFieldState CreateInstance(object value, string fieldName, PXSegment[] segments, string segmentViewName, DimensionLookupMode? lookupMode, bool? validCombos, string wildcard)
		{
			...
			if (String.IsNullOrEmpty(state._SegmentViewName))
			{
				...
				if(_segmentHeaderListCached == null)
					_segmentHeaderListCached = new [] { PXMessages.LocalizeNoPrefix("Value"), PXMessages.LocalizeNoPrefix("Description") };
				state._SegmentHeaderList = _segmentHeaderListCached;
