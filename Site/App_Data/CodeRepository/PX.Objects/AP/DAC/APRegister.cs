...
namespace PX.Objects.AP
{
	...
	{
		public static readonly string[] Values = { Hold, Balanced, Voided, Scheduled, Open, Closed, Printed, Prebooked, PendingApproval, Rejected, Reserved, PendingPrint};
		public static readonly string[] Labels = { Messages.Hold, Messages.Balanced, Messages.Voided, Messages.Scheduled, Messages.Open, Messages.Closed, Messages.Printed, Messages.Prebooked, Messages.PendingApproval, Messages.Rejected, Messages.Reserved, Messages.PendingPrint };
	...
	public partial class APRegister : IBqlTable, IRegister, IBalance, IDocumentKey
	{
		...
		/// </summary>
		[PXFormula(typeof(APRegister.curyInitDocBal))]
