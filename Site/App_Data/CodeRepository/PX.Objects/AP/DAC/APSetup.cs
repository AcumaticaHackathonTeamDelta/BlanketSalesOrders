...
namespace PX.Objects.AP
{
	...
	public partial class APSetup : IBqlTable
	{
		...
		public abstract class validateDataConsistencyOnRelease : IBqlField { }
		[Obsolete("This field is not used anymore and will be removed in 2018R2. Use " + nameof(DataInconsistencyHandlingMode) + "instead.")]
		...
		public abstract class dataInconsistencyHandlingMode : IBqlField { }
		[PXDBString(1)]
		...
		public abstract class loadVendorsPricesUsingAlternateID : IBqlField { }
		...
		public abstract class vendorPriceUpdate : PX.Data.IBqlField
		{
		}
		...
		public abstract class applyQuantityDiscountBy : PX.Data.IBqlField
		{
		}
        ...
        public abstract class suggestPaymentAmount : IBqlField { }
		...
		public abstract class migrationMode : IBqlField
		{
		}
		/// <summary>
	...
	public class APVendorPriceUpdateType
	{
		public class List : PXStringListAttribute
		{
			public List() : base(
				new[]
				{
					...
					Pair(Receipt, Messages.VendorUpdateReceipt),
					Pair(ReleaseReceipt, Messages.VendorUpdateReceiptRelease),
		...
		public const string ReleaseReceipt = "S";
