...
namespace PX.Objects.AP
{
	...
	public partial class APTran : IBqlTable, DR.Descriptor.IDocumentLine, ISortOrder
	{
		#region Selected
        ...
        /// </summary>
        /// <value>
        /// Equals <c>"DS"</c> for discounts and empty string for common lines.
        /// </value>
        ...
        /// (Presented in the currency of the document, see <see cref="APRegister.CuryID"/>)
        /// </summary>
        [PXDBPriceCostCalced(typeof(Switch<Case<Where<APTran.qty, Equal<decimal0>>, decimal0>, Div<APTran.curyTranAmt, APTran.qty>>), typeof(Decimal))]
