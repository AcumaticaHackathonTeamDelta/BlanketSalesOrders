...
namespace PX.Objects.AR
{
    public class ARDunningLetterPrint : PXGraph<ARDunningLetterPrint>
    {
        ...
        public partial class DetailsResult : IBqlTable
        {
			...
			public abstract class dunningLetterID : IBqlField
            {
            }
            [PXDBInt(IsKey = true)]
            ...
            #endregion
            #region LastLevel
			public abstract class lastLevel : IBqlField
            {
            }
			[PXDBBool]
            ...
            #region DontPrint
			public abstract class dontPrint : IBqlField
            {
            }
			[PXDBBool]
            [PXDefault(true)]
            ...
            #endregion
            #region DontEmail
			public abstract class dontEmail : IBqlField
            {
            }
			[PXDBBool]
            [PXDefault(true)]
            ...
            #endregion
            #region Emailed
			public abstract class emailed : IBqlField
            {
            }
			[PXDBBool]
            [PXDefault(false)]
			...
			[Obsolete("Will be removed in Acumtica 8.0")]
        ...
        public static void Print(PrintParameters filter, List<DetailsResult> list, bool markOnly)
        {
			...
			foreach (DetailsResult res in list)
            {
                ...
                else
                {
					...
					reportRedirectException = PXReportRequiredException.CombineReport(reportRedirectException, GetCustomerReportID(graph, "AR661000", res), reportParameters);
                }
            }
    ...
    public class ARDunningLetterUpdate : PXGraph<ARDunningLetterUpdate, Customer>
    {
		...
		public virtual void EMailDL(int dunningLetterID, bool markOnly, bool showAll)
        {
            ...
            else
            {
				...
				Activity.SendNotification(ARNotificationSource.Customer, notificationCD, dunningLetter.BranchID, new Dictionary<string, string>() { { "LetterID", dunningLetterID.ToString() } });
