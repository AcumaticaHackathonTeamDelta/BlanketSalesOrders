...
namespace PX.Objects.AR.Standalone
{
	...
	public class ARCashSale : ARRegister, ICCPayment, IApprovable, IApprovalDescription
	{
		...
		[PXDefault(typeof(Search<Location.cAvalaraCustomerUsageType, Where<Location.bAccountID, Equal<Current<ARCashSale.customerID>>, And<Location.locationID, Equal<Current<ARCashSale.customerLocationID>>>>>), PersistingCheck = PXPersistingCheck.Nothing)]
		...
		[TranPeriodID(typeof(ARCashSale.adjDate), BqlField = typeof(ARPayment.adjTranPeriodID))]
		...
		[ARCashSaleCashTranID(typeof(ARSetup.migrationMode))]
