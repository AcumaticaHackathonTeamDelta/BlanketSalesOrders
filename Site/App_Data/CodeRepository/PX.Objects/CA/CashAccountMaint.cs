...
namespace PX.Objects.CA
{
    ...
    public class CashAccountMaint : PXGraph<CashAccountMaint, CashAccount>
	{
        ...
        public PXSelectReadonly2<PaymentTypeInstance,
									LeftJoin<CR.BAccount, On<CR.BAccount.bAccountID, Equal<PaymentTypeInstance.bAccountID>>>,
						  Where<PaymentTypeInstance.cashAccountID, Equal<Current<CashAccount.cashAccountID>>>> PTInstances;
        ...
        public IEnumerable paymentMethodForRemittance()
        {
			...
			PXResultset<PaymentMethodAccount> payMethodAccounts = PXSelect<PaymentMethodAccount,
																	 Where2<
																			Where<PaymentMethodAccount.useForAP, Equal<True>,
																			   Or<PaymentMethodAccount.useForAR, Equal<True>>>,
																	    And<PaymentMethodAccount.cashAccountID, Equal<Current2<CashAccount.cashAccountID>>>>>.
																  Select(this);
        ...
        {
			PXSelectorAttribute.CheckAndRaiseForeignKeyException(sender, aAcct, typeof(VendorClass.cashAcctID));
			PXSelectorAttribute.CheckAndRaiseForeignKeyException(sender, aAcct, typeof(CR.Location.vCashAccountID));
			PXSelectorAttribute.CheckAndRaiseForeignKeyException(sender, aAcct, typeof(AR.CustomerPaymentMethod.cashAccountID));
			PXSelectorAttribute.CheckAndRaiseForeignKeyException(sender, aAcct, typeof(PaymentTypeInstance.cashAccountID));
        ...
        private CashAccountOptions DetectOptions()
        {
            ...
            CashAccountOptions result = CardsAllowed ? CashAccountOptions.HasPTInstances
													 : CashAccountOptions.None;
