...
namespace PX.Objects.CA
{
	...
	public partial class CABankTran : PX.Data.IBqlTable, ICADocSource
	{
        ...
        #region PayeeMatched
        [Obsolete(Common.Messages.FieldIsObsoleteRemoveInAcumatica8)]
        public abstract class payeeMatched : IBqlField
        {
        }

        /// <summary>
        /// The field is obsolete and will be removed in Acumatica ERP 7.0.
        /// There is a denormalize from the CA Bank Statement.
        /// </summary>
        [Obsolete(Common.Messages.PropertyIsObsoleteRemoveInAcumatica8)]
        [PXDBBool]
        [PXDefault(false)]
        [PXUIField(DisplayName = "PayeeMatched")]
        public virtual bool? PayeeMatched
        {
            get;
            set;
        }
        ...
        public virtual decimal? CuryReconciledDebit
        {
            ...
            get
            {
                return (this.DocumentMatched == true ? this.CuryDebitAmt : decimal.Zero);
            }
        ...
        [Obsolete(Common.Messages.FieldIsObsoleteRemoveInAcumatica8)]
        public abstract class showCreateDocument : IBqlField
        {
        }
        [Obsolete(Common.Messages.PropertyIsObsoleteRemoveInAcumatica8)]
        [PXBool]
        [PXUIField(Visible = false, Enabled = false)]
        public virtual bool? ShowCreateDocument
        {
            get
            {
        ...
        [Obsolete(Common.Messages.FieldIsObsoleteRemoveInAcumatica8)]
        public abstract class showInvoiceMatches : IBqlField
        {
        }
        [Obsolete(Common.Messages.PropertyIsObsoleteRemoveInAcumatica8)]
        [PXBool]
        [PXUIField(Visible = false, Enabled = false)]
        public virtual bool? ShowInvoiceMatches
        {
            get
            {
        ...
        public virtual int? CountDebit
        {
            ...
            get
            {
                return (this.DrCr == CADrCr.CADebit) ? (int)1 : (int)0;
            }
        ...
        public virtual int? CountCredit
        {
            ...
            get
            {
                return (this.DrCr == CADrCr.CACredit ? (int)1 : (int)0);
            }
        ...
        [Obsolete(Common.Messages.FieldIsObsoleteRemoveInAcumatica8)]
        public abstract class reconciledCountDebit : IBqlField
        {
        }

        [Obsolete(Common.Messages.PropertyIsObsoleteRemoveInAcumatica8)]
        [PXInt]
        public virtual int? ReconciledCountDebit
        {
        ...
        [Obsolete(Common.Messages.FieldIsObsoleteRemoveInAcumatica8)]
        public abstract class reconciledCountCredit : IBqlField
        {
        }

        [Obsolete(Common.Messages.PropertyIsObsoleteRemoveInAcumatica8)]
        [PXInt]
        public virtual int? ReconciledCountCredit
        {
        ...
        #region ShowMatches
        [Obsolete(Common.Messages.FieldIsObsoleteRemoveInAcumatica8)]
        public abstract class showMatches : IBqlField
        {
        }

        /// <summary>
        /// Specifies (if set to <c>true</c>) that the bank transaction is matched and it has related <see cref="CABankTranAdjustment"/> records.
        /// This is a virtual field and it has no representation in the database.
        /// </summary>
        [Obsolete(Common.Messages.PropertyIsObsoleteRemoveInAcumatica8)]
        [PXBool]
        [PXUIField(Visible = false, Enabled = false)]
        public virtual bool? ShowMatches
        {
            get
            {
