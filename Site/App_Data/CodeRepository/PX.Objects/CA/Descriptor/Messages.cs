...
namespace PX.Objects.CA
{
	...
	public static class Messages
	{
		...
		public const string HoldExpense = "The expense is on hold and cannot be released. Click View Expense and clear the On Hold check box.";
		...
		[Obsolete("This message is not used anymore and will be removed in Acumatica 2018R1")]
		public const string NotEnoughData = "Not enough data to create new document";
		...
		[Obsolete("This message is not used anymore and will be removed in Acumatica 2018R1")]
		public const string BankRuleWithKeyAlreadyExists = "Rule with this key already exists.";
		[Obsolete("This message is not used anymore and will be removed in Acumatica 2018R1")]
		public const string BankRuleNameRequired = "A valid name is required to create a rule.";
		...
		public const string UnmatchTranMsg = "The system will roll back all changes to the selected bank transaction and make it available for processing on the Process Bank Transactions form. The link to a matched document will be deleted, but a document will stay marked as cleared if it is included to a Reconciliation Statement. If a document was created to match the transaction, it should be handled manually, for instance, voided or matched. Proceed?";
		...
		[Obsolete("This message is not used anymore and will be removed in Acumatica 2018R1")]
		public const string TRansactionNotMatchedThereAreMatchCandididated = "Transaction is not matched; {0} payment candidates, {1} invoice candidates.";
		...
		[Obsolete("This message is not used anymore and will be removed in Acumatica 2018R1")]
		public const string DocumentIsNotReleased = "This document is not released. You have to release it first.";
		...
		public const string ProcessingCenterShouldTokenization = "The new processing center should support tokenization.";
		public const string ProcessingCenterShouldNotTokenization = "The old processing center should not support tokenization.";
		...
		public const string PaymentTypeInstance = "Payment Method Instance";
		public const string PaymentTypeInstanceDetail = "Payment Method Instance Detail";
		public const string PMInstance = "Payment Method Instance";
		public const string PTInstTran = "Payment Method Instance Transaction";
		#endregion
		...
		[Obsolete("This message is not used anymore and will be removed in Acumatica 2018R1")]
		public const string PrevStatementHasGreaterOREqualDate = "Previous Statement Has Greater Or Equal Date";
