...
namespace PX.Objects.CR
{
	...
	public class OUSearchEntity : IBqlTable
	{
        ...
        [PXFormula(typeof(Default<OUSearchEntity.outgoingEmail>))]
        ...
        public abstract class outgoingEmail : PX.Data.IBqlField { }
		...
		public abstract class contactBaccountID : IBqlField { }
		[PXDBInt]		
		...
		#endregion
		#region EntityName
		public abstract class entityName : PX.Data.IBqlField { }
	...
	public class OUMessage : IBqlTable
	{
		...
		#region EwsUrl
		public abstract class ewsUrl : PX.Data.IBqlField
		{
		}
		[PXString]
		...
		#region Token
		public abstract class token : PX.Data.IBqlField
		{
		}
		[PXString]
		...
		#region From
		public abstract class from : PX.Data.IBqlField
		{
		}
		...
		#endregion
		#region To
		public abstract class to : PX.Data.IBqlField
		{
		}
		...
		#endregion
		#region CC
		public abstract class cC : PX.Data.IBqlField
		{
		}
		...
		#endregion
        #region IsIncome
        public abstract class isIncome : PX.Data.IBqlField
        {
        }
	...
	public class OUOpportunity : IBqlTable
	{
		...
		[CROpportunityStages(typeof(cROpportunityClassID), OnlyActiveStages = true)]
		[PXDefault]
		...
		#region Amount
		public abstract class manualAmount : PX.Data.IBqlField { }
        ...
        [PXInt]
		[PXDefault(typeof(Search<Branch.branchID, Where<Branch.branchID, Equal<Current<AccessInfo.branchID>>>>))]
		[PXSelector(typeof(Search2<Branch.branchID, LeftJoin<Ledger, On<Ledger.defBranchID, Equal<Branch.branchID>>>, Where2<MatchWithBranch<Branch.branchID>, And<Ledger.ledgerID, IsNull>>>),
			SubstituteKey = typeof(Branch.branchCD),
			DescriptionField = typeof(Branch.acctName), CacheGlobal = true)]
	...
	public class OUActivity : IBqlTable
	{
		...
		public abstract class isLinkContact : IBqlField { }
		[PXBool]
		...
		#region IsLinkCase
		public abstract class isLinkCase : IBqlField { }
		[PXBool]
		[PXDefault(false, PersistingCheck = PXPersistingCheck.Nothing)]
		...
		public abstract class isLinkOpportunity : IBqlField { }
	...
	public class OUSearchMaint : PXGraph<OUSearchMaint>
	{
		...
		public PXSelect<Contact, 
			Where<Contact.eMail, Equal<Current<OUSearchEntity.eMail>>,
			  And<Contact.isActive, Equal<True>,
			  And<Contact.contactType, NotEqual<ContactTypesAttribute.bAccountProperty>>>>,
			OrderBy<Asc<CR.Contact.contactPriority, Desc<Contact.bAccountID, Asc<Contact.contactID>>>>> Contact;
  ...
  <soap:Body>
    <GetItem
      ...
      <ItemIds>
		...
		protected virtual void ExternalRedirect(PXRedirectRequiredException ex, bool popup = false, string append = null )
		{		
		...
		protected virtual void createLead()
		{
			if (this.Filter.VerifyRequired())
			{
				...
				string[] name = this.Filter.Current.DisplayName.Split(' ');
				contact.FirstName = name.Length > 1 ? name[0] : null;
				contact.LastName = name.Length > 1 ? name[name.Length - 1] : name[0];
				contact.EMail = this.Filter.Current.EMail;
				contact.BAccountID = this.Filter.Current.BAccountID;
				contact.DisplayName = this.Filter.Current.DisplayName;
				...
				else
				{
					PXResult<Contact,BAccount> acc =
						(PXResult < Contact, BAccount>)PXSelectJoin<Contact,
							...
							Where<CR.Contact.eMail, Equal<Required<CR.Contact.eMail>>>>
						.SelectSingleBound(this, null, this.Filter.Current.EMail);
					if (acc != null)
					{						
		...
		protected virtual bool PersisMessage(Guid? refNoteID, int? bAccountID, int? contactID)
		{			
            ...
            if (message == null)
			{
				...
				msg.MailFrom = this.Filter.Current.EMail;
		...
		protected virtual void OUSearchEntity_RowSelected(PXCache sender, PXRowSelectedEventArgs e)
        {
            ...
            if (!isIncome && !String.IsNullOrEmpty(row.OutgoingEmail))
                row.DisplayName = this.GetDisplayName(row.OutgoingEmail);
			...
			if (contact != null)
			{
				...
				ViewContact.SetCaption(Messages.View + ' ' + view);
			}
			else if(row.ContactType != null)
			{
				...
				{
					row.ErrorMessage = Messages.SomeCaseRequireCustomer;
            ...
            PXUIFieldAttribute.SetVisible<OUSearchEntity.errorMessage>(sender, row, row.ErrorMessage != null);
            ...
            if (message != null)
            {
                ...
                ViewEntity.SetCaption(Messages.View + ' ' + name);
            ...
            GoCreateLead.SetVisible(contact == null && row.EMail != null && row.ContactType == null && row.Operation == null && IsRights(typeof(LeadMaint), typeof(Contact), PXCacheRights.Insert));
            GoCreateContact.SetVisible(contact == null && row.EMail != null && row.ContactType == null && row.Operation == null && IsRights(typeof(ContactMaint), typeof(Contact), PXCacheRights.Insert));
        ...
        private bool IsRights(Type graphType, Type cacheType, PXCacheRights checkRights)
        {
