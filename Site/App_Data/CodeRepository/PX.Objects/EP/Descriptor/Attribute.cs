...
namespace PX.Objects.EP
{
        ...
        where Rejected : class, IBqlField
    {
        ...
        private void Initialize(PXGraph graph)
        {
            ...
            _FindOwner = CreateView(graph, BqlCommand.Compose(
                typeof(Select2<,,>), typeof(EPApproval),
                typeof(LeftJoin<EPRule,
                        On<EPRule.ruleID, Equal<EPApproval.ruleID>>>),
                typeof(Where<,,>),
            ...
            _FindWithWorkgroup = CreateView(graph, BqlCommand.Compose(
                typeof(Select2<,,>), typeof(EPApproval),
                typeof(LeftJoin<EPRule,
                        On<EPRule.ruleID, Equal<EPApproval.ruleID>>>),
                typeof(Where<,,>),
            ...
            _FindOwnerWithoutWorkgroup = CreateView(graph, BqlCommand.Compose(
                typeof(Select2<,,>), typeof(EPApproval),
                typeof(LeftJoin<EPRule,
                        On<EPRule.ruleID, Equal<EPApproval.ruleID>>>),
                typeof(Where<,,>),
            ...
            _Except = CreateView(graph, BqlCommand.Compose(
                typeof(Select<,>), typeof(EPApproval),
