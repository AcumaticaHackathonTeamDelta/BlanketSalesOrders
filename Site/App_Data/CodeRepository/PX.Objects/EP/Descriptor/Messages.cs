...
namespace PX.Objects.EP
{
	...
	public static class Messages
	{
		...
		public const string TipItemIsNotDefined = "To be able to specify non-zero tip amount in the expense receipt, specify an appropriate tip item in the Non-Taxable Tip Item box on the Time & Expenses Preferences (EP101000) form.";
		public const string LegacyReceipt = "This receipt was created on old version of Acumatica ERP. Taxes for this receipt will be calculated on updating Tax Zone, Tax Category, Tax Calculation Mode or Amount fields.";
        ...
        public const string LegacyClaimHeader = "This expense claim, which is a legacy expense claim created in an earlier version of Acumatica ERP, cannot be edited.";
        ...
        public const string TaxZoneCalcModeChangeOnReceiptsForm = "To change tax zone and tax calculation mode in expense receipts, use the Expense Receipt (EP301010) form.";
        ...
        public const string TaxCalcModeNotMatch = "Cannot add the expense receipt {0} to the expense claim {1} because they have different tax calculations mode specified.";
		public const string TipItemAssociatedWithTaxes = "The selected item is taxable and cannot be used as non-taxable tip item. Please select a tax-exempt item.";
