...
namespace PX.Objects.IN
{
	...
	public partial class InventoryItem : PX.Data.IBqlTable, PX.SM.IIncludable, ILotSerNumVal
	{
        #region Selected
		...
		[PXDefault(typeof(Search2<INItemClass.itemClassID, InnerJoin<INSetup,
			On<Current<InventoryItem.stkItem>, Equal<boolFalse>, And<INSetup.dfltNonStkItemClassID, Equal<INItemClass.itemClassID>,
				Or<Current<InventoryItem.stkItem>, Equal<boolTrue>, And<INSetup.dfltStkItemClassID, Equal<INItemClass.itemClassID>>>>>>>))]
		...
		public abstract class parentItemClassID : IBqlField { }
		...
		{
			[PXDependsOnFields(typeof(InventoryItem.itemClassID))]
			get
			{
				return (this.ItemClassID < 0 && this._ParentItemClassID > 0) ? this._ParentItemClassID : this.ItemClassID;
			}
			set
			{
				if (value != this.ItemClassID)
				{
		...
		/// <summary>
		/// The <see cref="Account"/> used to record discounts for the item.
		/// </summary>
		/// <value>
		/// Defaults to the <see cref="INPostClass.DiscAcctID">Discount Account</see> set on the <see cref="PostClassID">Posting Class</see> of the item.
		/// Corresponds to the <see cref="Account.AccountID"/> field.
		/// </value>
		...
		/// <summary>
		/// The <see cref="Sub">Subaccount</see> used to record discounts for the item.
		/// </summary>
		/// <value>
		/// Defaults to the <see cref="INPostClass.DiscSubID">Discount Sub.</see> set on the <see cref="PostClassID">Posting Class</see> of the item.
		/// Corresponds to the <see cref="Sub.SubID"/> field.
		/// </value>
		...
		[PXForeignReference(typeof(Field<dfltSiteID>.IsRelatedTo<INSite.siteID>))]
		...
		/// <summary>
		/// The shared start value for the auto-incremented segment for lot/serial tracking.
		/// This field is relevant only if the <see cref="FeaturesSet.LotSerialTracking">Lot/Serial Tracking</see> feature is enabled
		/// and the <see cref="INLotSerClass.LotSerNumShared"/> field is set to <c>true</c>
		/// on the corresponding <see cref="LotSerClassID">Lot/Serial Class</see>.
		/// </summary>
		/// <value>
		/// This field is unbound and automatically populated by the system from the <see cref="INLotSerClass.LotSerNumVal"/> field when needed.
		/// </value>
		[PXString]
		...
		/// <summary>
		/// When set to <c>true</c>, indicates that the same auto-increment value is used for all items
		/// in the <see cref="LotSerClassID">Lot/Serial Class</see>.
		/// This field is relevant only if the <see cref="FeaturesSet.LotSerialTracking">Lot/Serial Tracking</see> feature is enabled.
		/// </summary>
		/// <value>
		/// This field is unbound and automatically populated by the system from the <see cref="INLotSerClass.LotSerNumShared"/> field when needed.
		/// </value>
		[PXBool]
		...
		#endregion
		#region DefaultTerm
		public abstract class defaultTerm : IBqlField { }
		...
		public abstract class defaultTermUOM : IBqlField { }
        ...
        public abstract class completePOLine : PX.Data.IBqlField
        {
        }
        ...
        [PXUIField(DisplayName = "Complete PO Line")]
	...
	public class InventoryItemStatus
	{
		...
		public class unknown : Constant<string> { public unknown() : base(Unknown) { } }
	}
    ...
    public class CompletePOLineTypes
    {
        ...
        public class amount : Constant<string> { public amount() : base(Amount) { } }
        public class quantity : Constant<string> { public quantity() : base(Quantity) { } }
    }
