...
namespace PX.Objects.IN
{
	...
	Where<INItemCategory.inventoryID, Equal<Current<InventoryItem.inventoryID>>>> Category;
		...
		{
			INItemSite itemsite = (INItemSite)PXSelect<INItemSite, Where<INItemSite.inventoryID, Equal<Current<InventoryItem.inventoryID>>, And<INItemSite.siteID, Equal<Required<InventoryItem.dfltSiteID>>>>>.Select(this, ((InventoryItem)e.Row).DfltSiteID);
		...
		public virtual decimal? GetUnitRate(PXCache sender, INUnit unit, int? itemClassID)
		{
			...
			INUnit existingUnit = PXSelect<INUnit, Where<INUnit.unitType, NotEqual<INUnitType.inventoryItem>,
