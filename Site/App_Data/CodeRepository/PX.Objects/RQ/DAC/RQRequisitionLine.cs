...
using PX.Objects.PO;
	...
	public partial class RQRequisitionLine : PX.Data.IBqlTable
	{
		...
		[PXParent(typeof(Select<RQRequisition, Where<RQRequisition.reqNbr, Equal<Current<RQRequisitionLine.reqNbr>>>>))]
		...
		[Account(DisplayName = "Account", 
			Visibility = PXUIVisibility.Visible, Filterable = false, DescriptionField=typeof(Account.description))]		
		...
		#endregion
		#region IsUseMarkup
		public abstract class isUseMarkup : PX.Data.IBqlField
		{
		}
		...
		public abstract class transferRequest : PX.Data.IBqlField
		{
		}
		...
		public abstract class sourceTranReqNbr : PX.Data.IBqlField
		{
		}
		...
		public abstract class sourceTranLineNbr : PX.Data.IBqlField
		{
		}
		...
		#region TransferQty
		public abstract class transferQty : PX.Data.IBqlField
		{
		}
		...
		public abstract class baseTransferQty : PX.Data.IBqlField
		{
		}
		...
		#endregion				
		#region BiddingQty
		public abstract class biddingQty : PX.Data.IBqlField
		{
		}
		...
		public abstract class baseBiddingQty : PX.Data.IBqlField
		{
		}
		...
		#endregion				
		#region ByRequest
		public abstract class byRequest : PX.Data.IBqlField
		{
		}
		...
		#endregion
		#region QTOrderNbr
		public abstract class qTOrderNbr : PX.Data.IBqlField
		{
		}
		...
		#endregion
		#region QTLineNbr
		public abstract class qTLineNbr : PX.Data.IBqlField
		{
		}
		...
		#endregion
		#region Availability
		public abstract class availability : PX.Data.IBqlField
		{
		}
	...
	public partial class RQRequisitionLineReceived: IBqlTable
	{
		...
		#endregion
		#region POOrderQty
		public abstract class pOOrderQty : PX.Data.IBqlField
		{
		}
		...
		public abstract class pOReceivedQty : PX.Data.IBqlField
		{
		}
    ...
    [Serializable]
    [PXHidden]
	public partial class RQSOSource : IBqlTable
	{
		#region CustomerID
