		...
		<Items>
			<px:PXTabItem Text="General Settings">
				<Template>
                    ...
                    <px:PXDropDown ID="edDataInconsistencyHandlingMode" runat="server" DataField="DataInconsistencyHandlingMode" />
                        ...
                        <Levels>
                            <px:PXGridLevel DataMember="SetupApproval" >
                                ...
                                <Columns>
                                    ...
                                    <px:PXGridColumn DataField="DocType" Width="250px" CommitChanges="True" />
                                    <px:PXGridColumn DataField="AssignmentMapID" Width="250px"  TextField="AssignmentMapID_EPAssignmentMap_Name" AutoCallBack="True" LinkCommand="ViewAssignmentMap"/>
                                    <px:PXGridColumn DataField="AssignmentNotificationID" Width="250px" />
                                </Columns>
                            </px:PXGridLevel>
                        </Levels>                         
                    </px:PXGrid>
