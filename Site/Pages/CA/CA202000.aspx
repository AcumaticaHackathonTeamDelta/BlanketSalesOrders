						...
						<Levels>
							<px:PXGridLevel DataMember="ETDetails" DataKeyNames="AccountID,EntryTypeID">
								...
								<Columns>
									...
									<px:PXGridColumn DataField="CAEntryType__BranchID" Width="120px" />
									<px:PXGridColumn DataField="CAEntryType__AccountID" Width="120px" />
									<px:PXGridColumn DataField="CAEntryType__SubID" Width="140px" />
									<px:PXGridColumn DataField="CAEntryType__CashAccountID" Width="120px" />
									...
									<px:PXGridColumn DataField="OffsetBranchID" Width="108px" />
									<px:PXGridColumn DataField="OffsetAccountID" Width="120px" CommitChanges="True"/>
									<px:PXGridColumn DataField="OffsetSubID" Width="108px" />
									<px:PXGridColumn AutoCallBack="True" DataField="TaxZoneID" Width="108px" />
									<px:PXGridColumn DataField="TaxCalcMode" Width="108px" />
								</Columns>
								<Layout FormViewHeight="" />
							</px:PXGridLevel>
						</Levels>
