	...
	<px:PXFormView ID="form" runat="server" DataSourceID="ds" Width="100%"
		...
		<Template>
			<px:PXLayoutRule runat="server" StartColumn="True" LabelsWidth="SM" ControlSize="XM" />
                ...
                <px:PXLayoutRule runat="server" StartColumn="True" LabelsWidth="SM" ControlSize="XM" />
                <px:PXTextEdit ID="edCompanyName" runat="server" DataField="FullName"  TabIndex="220" />
				...
				<Template>
				    ...
				    <px:PXLayoutRule ID="PXLayoutRule12" runat="server" GroupCaption="Contact" StartGroup="True" />
                        ...
                        <px:PXLayoutRule ID="PXLayoutRule15" runat="server" Merge="True" />                            
                            <px:PXDropDown ID="Phone3Type" runat="server" DataField="Phone3Type" Size="S" SuppressLabel="True" CommitChanges="True" />
					    ...
					    <px:PXFormView ID="formA" runat="server" DataMember="AddressCurrent" DataSourceID="ds"
						    ...
						    <Template>
                                ...
                                <px:PXLayoutRule runat="server" Merge="True" />
							        ...
							        <px:PXButton ID="btnViewOnMap" runat="server" CommandName="ViewOnMap" CommandSourceID="ds" Size="xs" Text="View On Map" Height="20px" />
                                <px:PXLayoutRule runat="server" />
                    ...
                    <px:PXLayoutRule ID="PXLayoutRule3" runat="server" GroupCaption="CRM" StartGroup="True" ControlSize="XM" LabelsWidth="M"/>
                        <px:PXSelector ID="edClassID" runat="server" AllowEdit="True" DataField="ClassID" TabIndex="100" FilterByAllFields="True" TextMode="Search" CommitChanges="True"/>                
                        <px:PXDropDown ID="Source" runat="server" DataField="Source"  TabIndex="110" CommitChanges="True"/> 
                        <px:PXSelector ID="CampaignID" runat="server" DataField="CampaignID"  TabIndex="120" CommitChanges="True"/>
					<px:PXDropDown ID="edDuplicateStatus" runat="server" DataField="DuplicateStatus" CommitChanges="True" Enabled="False"/> 
                    <px:PXDropDown ID="Method" runat="server" DataField="Method"  TabIndex="130" />
					    <px:PXLayoutRule ID="PXLayoutRule5" runat="server" Merge="True" />
					        <px:PXCheckBox ID="edNoCall" runat="server" DataField="NoCall" Size="S"  TabIndex="140" SuppressLabel="True" Width="112" />
					        <px:PXCheckBox ID="edNoFax" runat="server" DataField="NoFax" Size="S"  TabIndex="150" SuppressLabel="True" />
					    <px:PXLayoutRule ID="PXLayoutRule7" runat="server" />
					    <px:PXLayoutRule ID="PXLayoutRule8" runat="server" Merge="True" />
					        <px:PXCheckBox ID="edNoEMail" runat="server" DataField="NoEMail"  TabIndex="160" Size="S" SuppressLabel="True" Width="112" />
					        <px:PXCheckBox ID="edNoMail" runat="server" DataField="NoMail" Size="S"  TabIndex="170" SuppressLabel="True" />
					    <px:PXLayoutRule ID="PXLayoutRule9" runat="server" />
					    <px:PXLayoutRule ID="PXLayoutRule10" runat="server" Merge="True" />													
                            <px:PXCheckBox ID="edNoMassMail" runat="server" DataField="NoMassMail" Size="S"  TabIndex="180" Width="112" />					        
                            <px:PXCheckBox ID="edNoMarketingMaterials" runat="server" DataField="NoMarketing" Size="S"  TabIndex="190" />   					        
					    <px:PXLayoutRule ID="PXLayoutRule11" runat="server" />
					    <px:PXDateTimeEdit ID="edLastIncomingDate" runat="server" DataField="LeadActivityStatistics.LastIncomingActivityDate" Enabled="False" Size="SM"  TabIndex="200"/>
                        <px:PXDateTimeEdit ID="edLastOutgoingDate" runat="server" DataField="LeadActivityStatistics.LastOutgoingActivityDate" Enabled="False" Size="SM"  TabIndex="210"/>                        
                        
                        <px:PXSegmentMask ID="edParentBAccountID" runat="server" AllowEdit="True" DataField="ParentBAccountID"  TabIndex="230"
