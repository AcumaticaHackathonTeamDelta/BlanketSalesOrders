		...
		<Items>
			<px:PXTabItem Text="Details" RepaintOnDemand="False">
				<Template>
                    ...
                    <px:PXDropDown ID="Method" runat="server" TabIndex="100" DataField="Method" />
					    ...
					    <px:PXDateTimeEdit ID="edLastIncomingDate" runat="server"  TabIndex="170" DataField="ContactActivityStatistics.LastIncomingActivityDate" Enabled="False" Size="SM"/>
                        <px:PXDateTimeEdit ID="edLastOutgoingDate" runat="server"  TabIndex="180" DataField="ContactActivityStatistics.LastOutgoingActivityDate" Enabled="False" Size="SM"/>                        
                        <px:PXTextEdit ID="edCompanyName" runat="server" DataField="FullName"  TabIndex="190" />					    
                        <px:PXSegmentMask ID="edParentBAccountID" runat="server" AllowEdit="True"  TabIndex="200" DataField="ParentBAccountID"
						FilterByAllFields="True" TextMode="Search" DataSourceID="ds" />
		        <px:PXLayoutRule runat="server" GroupCaption="Person" StartGroup="True" />
                        <px:PXSelector ID="edLanguageID" runat="server" AllowEdit="True"  TabIndex="210" DataField="LanguageID"
								        TextMode="Search" DataSourceID="ds" DisplayMode="Hint"  />
                        <px:PXDateTimeEdit ID="edBirthday" runat="server" DataField="DateOfBirth"  TabIndex="220" />
                        <px:PXDropDown ID="ddGender" runat="server" DataField="Gender"  TabIndex="230" />
                        <px:PXDropDown ID="ddMartialStatus" runat="server" DataField="MaritalStatus"  TabIndex="240" />
                        <px:PXTextEdit ID="teSpouse" runat="server" DataField="Spouse"  TabIndex="250" />                    
				</Template>
			</px:PXTabItem>
				...
				<Template>
					...
					<px:PXPanel ID="PXPanel2" runat="server" RenderSimple="True" RenderStyle="Simple">
						...
						<px:PXDropDown ID="edSource" runat="server" DataField="Source" SelectedIndex="2"
							Enabled="False" />
                        <px:PXSelector ID="edCampaignID" runat="server" DataField="CampaignID" CommitChanges="True" Enabled="False"/>
						...
						<px:PXDropDown ID="edResolution" runat="server" DataField="Resolution" SelectedIndex="1"
							Enabled="False" />
                        <px:PXSelector ID="edConvertedBy" runat="server" DataField="ConvertedBy" Enabled="False"/>
					    <px:PXTextEdit ID="edQualificationDate" runat="server" DataField="QualificationDate" Enabled="False"/>
					</px:PXPanel>
