		...
		<Items>
			<px:PXTabItem Text="Details" RepaintOnDemand="false">
				<Template>
                    ...
                    <px:PXDropDown ID="edDuplicateStatus1" runat="server" DataField="Contact__DuplicateStatus" Enabled="False"/>                  
                    <px:PXDateTimeEdit ID="edLastIncomingDate" runat="server" DataField="BAccountActivityStatistics.LastIncomingActivityDate" Enabled="False" Size="SM"/>
                    <px:PXDateTimeEdit ID="edLastOutgoingDate" runat="server" DataField="BAccountActivityStatistics.LastOutgoingActivityDate" Enabled="False" Size="SM"/>
                    ...
                    <px:PXSelector ID="edLanguageID" runat="server" AllowEdit="True" DataField="DefContact.LanguageID" TextMode="Search" DataSourceID="ds" DisplayMode="Hint"  />
