            ...
            <Levels>
                <px:PXGridLevel DataMember="ReceiptsForSubmit"  DataKeyNames="ClaimDetailID">
                    <Columns>
                        ...
                        <px:PXGridColumn DataField="EmployeeID" Width="130px" />
                        <px:PXGridColumn DataField="BranchID" />
                        <px:PXGridColumn DataField="TranDesc"  Width="250px" LinkCommand="ViewUnsubmitReceipt" />
            ...
            <Levels>
                ...
                <px:PXGridLevel DataMember="Tax_Rows">
                   	<Columns>
						...
						<px:PXGridColumn DataField="CuryTaxableAmt" TextAlign="Right" Width="100px" CommitChanges="true" />
						<px:PXGridColumn DataField="CuryTaxAmt" TextAlign="Right" Width="100px"  CommitChanges="true" />
						<px:PXGridColumn DataField="NonDeductibleTaxRate" TextAlign="Right" Width="100px" />
						<px:PXGridColumn DataField="CuryExpenseAmt" TextAlign="Right" Width="100px" CommitChanges="true" />
                        ...
                        <Levels>
                            <px:PXGridLevel DataMember="ExpenseClaimDetails" DataKeyNames="ClaimDetailID">
                                <Columns>
                                    ...
                                    <px:PXGridColumn DataField="CuryTaxTotal" TextAlign="Right" Width="80px" LinkCommand="ViewTaxes" />
                                    <px:PXGridColumn DataField="CuryEmployeePart" TextAlign="Right" Width="60px" />
									<px:PXGridColumn DataField="CuryTipAmt" TextAlign="Right" Width="60px" CommitChanges="True" />
                                    <px:PXGridColumn DataField="CuryTranAmtWithTaxes" TextAlign="Right" Width="60px" />
                                    ...
                                    <px:PXGridColumn DataField="Billable" TextAlign="Center" Type="CheckBox" AutoCallBack="True" TextCase="Upper" Width="40px" />
                                     <px:PXGridColumn DataField="ContractID" Width="60px" AutoCallBack="True" LinkCommand="ViewProject"/>
									...
									<px:PXGridColumn DataField="TaxZoneID" Width="70px" />
									<px:PXGridColumn DataField="TaxCalcMode" Width="70px" />
                                    <px:PXGridColumn DataField="BranchID" Width="70px" />
                                    <px:PXGridColumn DataField="ARRefNbr" Width="100px"/>
									<px:PXGridColumn DataField="APRefNbr" Width="100px"/>
                        ...
                        <Levels>
                            <px:PXGridLevel DataMember="Taxes" DataKeyNames="RefNbr,ClaimDetailID,TaxID">
                                ...
                                <Columns>
                                    ...
                                    <px:PXGridColumn DataField="NonDeductibleTaxRate" TextAlign="Right" Width="81px" />
                                    <px:PXGridColumn DataField="CuryExpenseAmt" TextAlign="Right" Width="81px" />
                  ...
                  <px:PXGrid ID="apDocsGrig" runat="server"  Width="650px" Height="100px" TabIndex="11900" DataSourceID="ds"
                       ...
                       <Levels>
						   <px:PXGridLevel DataMember="APDocuments">
							   <Columns>
								   <px:PXGridColumn DataField="DocType" Width="40px" />
								   <px:PXGridColumn DataField="RefNbr" AutoCallBack="True" LinkCommand="ViewInvoice" Width="70px" />
								   <px:PXGridColumn DataField="CuryOrigDocAmt" Width="50px" />
								   <px:PXGridColumn DataField="TaxZoneID" Width="81px" />
								   <px:PXGridColumn DataField="TaxCalcMode" Width="81px" />
                     ...
                     <px:PXLayoutRule ID="PXLayoutRule2" runat="server" ControlSize="XM" GroupCaption="Default Tax Info" LabelsWidth="SM" StartGroup="True" />
