        ...
        <px:PXGrid ID="PXGridComponentSelected" runat="server" DataSourceID="ds" 
            ...
            <Levels>
                <px:PXGridLevel 
                    ...
                    <Columns>
                        <px:PXGridColumn DataField="LineRef" Width="100px">
                        </px:PXGridColumn>
                        <px:PXGridColumn DataField="ComponentID" Width="120px">
                        </px:PXGridColumn>
                        <px:PXGridColumn DataField="Status" Type="DropDownList" Width="120px" CommitChanges="true">
                        </px:PXGridColumn>
                        <px:PXGridColumn DataField="LongDescr" Width="150px">
                        </px:PXGridColumn>
                        <px:PXGridColumn DataField="ItemClassID" Width="120px" CommitChanges="true">
                        </px:PXGridColumn>
                        <px:PXGridColumn DataField="InventoryID" Width="120px" CommitChanges="true">
                        </px:PXGridColumn>
                        <px:PXGridColumn DataField="SerialNumber" Width="120px">
                        </px:PXGridColumn>
                        <px:PXGridColumn DataField="CpnyWarrantyDuration" TextAlign="Right" Width="100px" CommitChanges="True">
                        </px:PXGridColumn>
                        <px:PXGridColumn DataField="CpnyWarrantyType" Width="100px" CommitChanges="True">
                        </px:PXGridColumn>
                        <px:PXGridColumn DataField="CpnyWarrantyEndDate" Width="120px">
                        </px:PXGridColumn>  
                        <px:PXGridColumn DataField="VendorWarrantyDuration" TextAlign="Right" Width="100px" CommitChanges="True">
                        </px:PXGridColumn>
                        <px:PXGridColumn DataField="VendorWarrantyType" Width="100px" CommitChanges="True">
                        </px:PXGridColumn>
                        <px:PXGridColumn DataField="VendorWarrantyEndDate" Width="120px">
                        </px:PXGridColumn>
                        <px:PXGridColumn DataField="VendorID" Width="120px">
                        </px:PXGridColumn>          
                        <px:PXGridColumn DataField="Comment" Width="150px">
                        </px:PXGridColumn>
                        <px:PXGridColumn DataField="InstallationDate" Width="120px" CommitChanges="True">
                        </px:PXGridColumn>    
                        <px:PXGridColumn DataField="SalesDate" Width="120px" CommitChanges="True">
                        </px:PXGridColumn>
                        <px:PXGridColumn DataField="InstServiceOrderID" Width="120px">
                        </px:PXGridColumn> 
                        <px:PXGridColumn DataField="InstAppointmentID" Width="120px">
                        </px:PXGridColumn>        
                        <px:PXGridColumn DataField="InvoiceRefNbr" Width="120px">
                        </px:PXGridColumn>    
                        <px:PXGridColumn DataField="SalesOrderNbr" Width="120px">
                        </px:PXGridColumn>
                        <px:PXGridColumn DataField="ComponentReplaced" Width="120px">
                        </px:PXGridColumn>                           
                    </Columns>
                </px:PXGridLevel>
            </Levels>
...
<asp:Content ID="cont2" ContentPlaceHolderID="phF" runat="Server">
    <px:PXFormView ID="form" runat="server" DataSourceID="ds" Style="z-index: 100" MarkRequired="Dynamic"
		Width="100%" Height="300px" DataMember="EquipmentRecords" TabIndex="29900" DefaultControlID="edDescr">
        <Template>
            <px:PXLayoutRule runat="server" StartRow="True" StartColumn="True" LabelsWidth="SM">
            </px:PXLayoutRule>
            <px:PXSelector ID="edRefNbr" runat="server" DataField="RefNbr" AutoRefresh="True" Size="M" DataSourceID="ds">
            </px:PXSelector>
            ...
            <px:PXLayoutRule runat="server" StartRow="True" ColumnSpan="2" LabelsWidth="SM"></px:PXLayoutRule>
            <px:PXTextEdit ID="edDescr" runat="server" DataField="Descr">
            </px:PXTextEdit>
            <px:PXLayoutRule runat="server" StartRow="True" LabelsWidth="SM"></px:PXLayoutRule>
            <px:PXGroupBox 
                ID="ebOwnerType" 
                runat="server" 
                Caption="Owner" 
                ...
                <Template>
                    ...
                    <px:PXLabel runat="server" Height="24px"></px:PXLabel>
		...
		<Items>
            <px:PXTabItem Text="General Info">
                <Template>
                    ...
                    <px:PXDateTimeEdit ID="edSalesDate" runat="server"  DataField="SalesDate">
                    </px:PXDateTimeEdit>
                    <px:PXSelector ID="edColorID" runat="server" DataField="ColorID">
                    </px:PXSelector>
                    <px:PXLayoutRule runat="server" StartGroup="True" GroupCaption="Installation Info" LabelsWidth="SM">
                    </px:PXLayoutRule>
                    ...
                    <px:PXLayoutRule runat="server" StartGroup="True" GroupCaption="Disposal Info" LabelsWidth="SM">
                    </px:PXLayoutRule>
                    ...
                    <px:PXLayoutRule runat="server" StartColumn="True" StartGroup="True" GroupCaption="Manufacturer Info" LabelsWidth="SM">
                    </px:PXLayoutRule>
            ...
            <px:PXTabItem Text="Components and Warranties">
                <Template>
                    <px:PXFormView runat="server" ID="formCompWarr" DataMember="EquipmentSelected" Style="z-index: 100" Width="100%">
						...
						<Template>
                            <px:PXLayoutRule runat="server" GroupCaption="Company General Warranty" StartGroup="True" StartColumn="true" LabelsWidth="M" ControlSize="S">
                            </px:PXLayoutRule>
                            ...
                            <px:PXLayoutRule runat="server" GroupCaption="Vendor General Warranty" StartGroup="True" StartColumn="true" LabelsWidth="M" ControlSize="S">
                            </px:PXLayoutRule>
                            <px:PXLayoutRule runat="server" Merge="True">
                            </px:PXLayoutRule>
                    ...
                    <px:PXGrid ID="PXGridWarranty" runat="server" DataSourceID="ds" 
                        SkinID="Details" TabIndex="4200" Height="100%" Width="100%" SyncPosition="True" KeepPosition="true">
                        <Levels>
                            <px:PXGridLevel 
                                ...
                                <RowTemplate>
                                    ...
                                    <px:PXSelector runat="server" ID="edVendorID" DataField="VendorID" AllowEdit="true"> 
                                    </px:PXSelector>
                                </RowTemplate>
                                <Columns>
                                    <px:PXGridColumn DataField="LineRef" Width="100px">
                                    </px:PXGridColumn>
                                    <px:PXGridColumn DataField="ComponentID" Width="120px" CommitChanges="true">
                                    </px:PXGridColumn>
                                    <px:PXGridColumn DataField="Status" Type="DropDownList" Width="120px" CommitChanges="true">
                                    </px:PXGridColumn>
                                    <px:PXGridColumn DataField="LongDescr" Width="150px">
