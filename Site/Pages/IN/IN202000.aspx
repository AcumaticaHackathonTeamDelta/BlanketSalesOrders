        ...
        <Items>
            ...
            <px:PXTabItem Text="Service Management" LoadOnDemand="True" RepaintOnDemand="False" VisibleExp="DataControls[&quot;chkServiceManagement&quot;].Value == 1" BindingContext="form">
                <Template>
                    ...
                    <px:PXCheckBox runat="server" ID="edAutoShowNote" DataField="AutoShowNote" AlignLeft="True" />
                    <px:PXCheckBox runat="server" ID="edRouteService" DataField="ItemClass.Mem_RouteService" AlignLeft="True" Enabled="False" />
                </Template>
            </px:PXTabItem>
