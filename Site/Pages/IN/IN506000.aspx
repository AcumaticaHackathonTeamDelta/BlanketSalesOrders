		...
		<Levels>
			<px:PXGridLevel  DataMember="ResultPreview">
				<Columns>
					...
					<px:PXGridColumn DataField="OldABCCode" Width="90px" />
                    <px:PXGridColumn DataField="ABCCodeFixed" TextAlign="Center" Type="CheckBox" />
					<px:PXGridColumn DataField="YtdCost" TextAlign="Right" Width="100px" />
					<px:PXGridColumn DataField="Ratio" TextAlign="Right" Width="100px" />
					<px:PXGridColumn DataField="CumulativeRatio" TextAlign="Right" Width="100px" />
					<px:PXGridColumn DataField="NewABCCode" Width="90px" />	
				</Columns>
			</px:PXGridLevel>
		</Levels>
