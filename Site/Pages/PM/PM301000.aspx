        ...
        <Items>
            <px:PXTabItem Text="Summary">
                <Template>
                    ...
                    <px:PXLayoutRule runat="server" StartGroup="True" GroupCaption="CRM" />
                    <px:PXSelector ID="edCampaignID" runat="server" DataField="CampaignID" AllowEdit="True" AllowAddNew="True" CommitChanges="true" />
                        ...
                        <Levels>
                            <px:PXGridLevel DataMember="Tasks" DataKeyNames="ProjectID,TaskCD">
                                ...
                                <Columns>
                                    ...
                                    <px:PXGridColumn DataField="Status" RenderEditorText="True" Width="81px" AutoCallBack="True" />
                                    <px:PXGridColumn DataField="CompletedPercent" TextAlign="Right" Width="99px" />
                                    <px:PXGridColumn DataField="RetainagePct" TextAlign="Right" Width="99px" />
            ...
            <px:PXTabItem Text="Revenue Budget" LoadOnDemand="False">
                <Template>
                    ...
                    <px:PXGrid ID="RevenueBudgetGrid" runat="server" DataSourceID="ds" Style="z-index: 100" Width="100%" Height="150px" SkinID="DetailsInTab" SyncPosition="True" OnRowDataBound="BudgetGrid_RowDataBound">
                        <Levels>
                            <px:PXGridLevel DataMember="RevenueBudget">
                                <Columns>
                                    ...
                                    <px:PXGridColumn DataField="Rate" Label="Rate" TextAlign="Right" Width="99px" CommitChanges="true" />
                                    <px:PXGridColumn DataField="Amount" Label="Amount" TextAlign="Right" Width="81px" CommitChanges="true" />
                                    <px:PXGridColumn DataField="RevisedQty" Label="Revised Qty" TextAlign="Right" Width="81px" CommitChanges="true" />
                                    <px:PXGridColumn DataField="RevisedAmount" Label="Revised Amount" TextAlign="Right" Width="81px" CommitChanges="true" />
                                    ...
                                    <px:PXGridColumn DataField="MaxAmount" TextAlign="Right" Width="81px" />
                                    <px:PXGridColumn DataField="ChangeOrderQty" TextAlign="Right" Width="81px" />
                                    <px:PXGridColumn DataField="ChangeOrderAmount" TextAlign="Right" Width="81px" />
                                    <px:PXGridColumn DataField="CommittedQty" Label="Committed Qty" TextAlign="Right" Width="81px" />
                                    <px:PXGridColumn DataField="CommittedAmount" Label="Committed Amount" TextAlign="Right" Width="81px" />
                                    ...
                                    <px:PXGridColumn DataField="CommittedInvoicedAmount" Label="Committed Amount" TextAlign="Right" Width="81px" />
                                    <px:PXGridColumn DataField="CommittedOpenQty" Label="Committed Open Qty" TextAlign="Right" Width="81px" />
                                    <px:PXGridColumn DataField="CommittedOpenAmount" Label="Committed Open Amount" TextAlign="Right" Width="81px" />
                                    ...
                                    <px:PXGridColumn DataField="ActualPlusOpenCommittedAmount" TextAlign="Right" Width="81px" />
                                    <px:PXGridColumn DataField="VarianceAmount" TextAlign="Right" Width="81px" />
                                    <px:PXGridColumn DataField="PrepaymentPct" TextAlign="Right" Width="100px" CommitChanges="true" />
                                    <px:PXGridColumn DataField="PrepaymentAmount" TextAlign="Right" Width="81px" CommitChanges="true" />
                                    <px:PXGridColumn DataField="PrepaymentInvoiced" TextAlign="Right" Width="81px" CommitChanges="true" />
                                    <px:PXGridColumn DataField="PrepaymentAvailable" TextAlign="Right" Width="81px" CommitChanges="true" />
                                    <px:PXGridColumn DataField="CompletedPct" TextAlign="Right" Width="100px" CommitChanges="true" />
                                    <px:PXGridColumn DataField="AmountToInvoice" TextAlign="Right" Width="81px" CommitChanges="true" />
            ...
            <px:PXTabItem Text="Cost Budget" LoadOnDemand="False">
                <Template>
                    ...
                    <px:PXGrid ID="CostBudgetGrid" runat="server" DataSourceID="ds" Style="z-index: 100" Width="100%" Height="150px" SkinID="DetailsInTab" SyncPosition="True" OnRowDataBound="BudgetGrid_RowDataBound">
                        <Levels>
                            <px:PXGridLevel DataMember="CostBudget">
                                ...
                                <Columns>
                                    ...
                                    <px:PXGridColumn DataField="Type" TextAlign="Right" Width="81px"/>
                                    <px:PXGridColumn DataField="Rate" TextAlign="Right" Width="99px" CommitChanges="true" />
                                    ...
                                    <px:PXGridColumn DataField="RevisedAmount" TextAlign="Right" Width="81px" CommitChanges="true" />
                                    <px:PXGridColumn DataField="ChangeOrderQty" TextAlign="Right" Width="81px" />
                                    <px:PXGridColumn DataField="ChangeOrderAmount" TextAlign="Right" Width="81px" />
                                    <px:PXGridColumn DataField="CommittedQty" TextAlign="Right" Width="81px" />
                                    <px:PXGridColumn DataField="CommittedAmount" TextAlign="Right" Width="81px" />
                                    ...
                                    <px:PXGridColumn DataField="CommittedInvoicedAmount" TextAlign="Right" Width="81px" />
                                    <px:PXGridColumn DataField="CommittedOpenQty" TextAlign="Right" Width="81px" />
                                    <px:PXGridColumn DataField="CommittedOpenAmount" TextAlign="Right" Width="81px" />
                                    ...
                                    <px:PXGridColumn DataField="LastCostToComplete" TextAlign="Right" Width="81px" />
                                    <px:PXGridColumn DataField="CostToComplete" TextAlign="Right" Width="81px" />
                                    ...
                                    <px:PXGridColumn DataField="LastCostAtCompletion" TextAlign="Right" Width="81px" />
                                    <px:PXGridColumn DataField="CostAtCompletion" TextAlign="Right" Width="81px" />
                        ...
                        <Levels>
                            <px:PXGridLevel DataMember="Invoices">
                                <Columns>
                                    ...
                                    <px:PXGridColumn DataField="PMProforma__DocTotal" Width="99px" />
                                    ...
                                    <px:PXGridColumn DataField="ARInvoice__OrigDocAmt" TextAlign="Right" Width="100px" />
                                </Columns>
                            </px:PXGridLevel>
                        </Levels>
                        <AutoSize Enabled="True" />
