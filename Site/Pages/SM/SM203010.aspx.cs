	...
	private void ShowHideOutlookManifest()
	{
			...
			&& tab.Items["EmailSettings"].TemplateContainer.FindControl("form2") != null)
		{
			...
			if (outlookLinkControl != null)
			{
				...
				var value = (cache != null && feature != null) ? cache.GetValue(feature, "IsInstalled") : null;
				var installed = value != null && (bool?)value == true;
				outlookLinkControl.Visible = installed;
				if(btnHelpControl != null)
					btnHelpControl.Visible = installed;
			}
		}
	}
}
